...
namespace CareerCloud.WebAPI.Controllers
{
    ...
    public class CompanyDescriptionController : ApiController
    {
        ...
        public CompanyDescriptionController()
        {
            ...
            logic = new CompanyDescriptionLogic(new CompanyDescriptionRepository());
        }
        ...
        {
            CompanyDescriptionPoco poco = logic.Get(CompanyDescriptionId);
            if (poco == null)
            {
                return NotFound();
            }
        ...
        {
            List<CompanyDescriptionPoco> results = logic.GetAll();
