...
namespace CareerCloud.WebAPI.Controllers
{
    ...
    public class SecurityLoginController : ApiController
    {
        ...
        {          
            SecurityLoginRepository repository = new SecurityLoginRepository();
        ...
        {
            SecurityLoginPoco poco = logic.Get(SecurityLoginId);
            if (poco == null)
            {
                return NotFound();
            }
        ...
        {
            List<SecurityLoginPoco> results = logic.GetAll();
